...
impl BtnTest {
    ...
    pub fn new(
        ...
        let btn_0_1mm = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 0, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 0, 1);
        ...
        let btn_1mm = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 1, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 0, 1);
        ...
        let btn_10mm = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 2, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 0, 1);
        ...
        let btn_up = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 0, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 1, 1);
        ...
        let btn_home = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 1, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 1, 1);
        ...
        let btn_down = Btn::new(screen).apply(|obj| {
            ...
            .set_grid_cell(lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 2, 1, lvgl_sys::lv_grid_align_t_LV_GRID_ALIGN_STRETCH, 1, 1);
...
fn main() {
    let mut displays: SimulatorDisplay<Rgb565> = SimulatorDisplay::new(Size::new(
        320,
        240,
    ));
    ...
    pub fn idle_task(
        ...
        pub fn into_lvgl_event_press(p: &Point) -> TouchPad {
            let e = TouchPad::Pressed { x: p.x as i16, y: p.y as i16 };
